...
par(mfrow=c(2,2))
plot(data_work$DateTime,data_work$Global_active_power, ylab = "Global Active Power(Kilowatt)",main = "Global Active Power", type = "l", xlab = " ")
plot(data_work$DateTime,data_work$Voltage, ylab = "Voltage", type = "l", xlab = "datetime")
...
plot(data_work$DateTime,data_work$Global_reactive_power, ylab = "Global_Reactive_Power", type = "l", xlab = "datetime")
dev.off()